...
WebDriver driver;
	...
	@Test(dependsOnMethods="launch") // Dependency Feature: This test case is dependent on the result of launch
	public void link3() {
	boolean b2 = driver.findElement(By.linkText("Fleet")).isDisplayed();
	System.out.println(b2);
	}
		
	@Test(invocationCount=5) // Invocation Count; This feature will allow you to run a particular test case for n number of times
	public void link4() {
	boolean b2 = driver.findElement(By.linkText("Fleet")).isDisplayed();
	System.out.println(b2);
	}
